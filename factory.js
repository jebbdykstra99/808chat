(function () {
  ...
  let SITE_ID = '808chat';
  let site = null;
  let COLORS = ['#0b3d4a', '#d45d6c', '#1a6b78', '#2c1810', '#b84a58', '#3d7a86'];
  let TRENDS = [];
  let PLACES = [];
  let TOPICS = [];
  ...
  function wireEvents() {
    ...
    document.getElementById('cv-guest-login').addEventListener('click', function () { stubSignIn('Guest', 'guest808'); });
  ...
  fetch(SITE_JSON_URL)
    ...
    .catch(function (e) {
      ...
      boot({ siteId: "808chat", name: "808chat", tagline: "All things Hawaii." });
    });
})();
